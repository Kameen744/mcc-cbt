...
var base_url = window.location.origin + "/" + pathNames[1];
var questionsArray = [];
...
$(document).on('click', '#addRemoveDept', function () {
  loadingMd();
  var post = new ajxobj(base_url + '/admin/addRemoveDepartments');
...
$(document).on('click', '#editDeptBtn', function () {
  var post = new ajxobj(base_url + '/admin/editDepartment/' + $(this).val());
  post.jxhr.done(function (res) {
...
$(document).on('click', '#delDeptBtn', function () {
  var post = new ajxobj(base_url + '/admin/deleteDepartment/' + $(this).val());
  post.jxhr.done(function (res) {
    $('#adminPage').html(res);
  });
});
...
$(document).on('click', '#addRemoveCourses', function () {
  var post = new ajxobj(base_url + '/admin/addRemoveCourses');
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
  });
...
$(document).on('click', '#delCourseBtn', function () {
  var post = new ajxobj(base_url + '/admin/deleteCourse/' + $(this).val());
  post.jxhr.done(function (res) {
    $('#adminPage').html(res);
  });
});
...
$(document).on('change', '#SelectDept', function () {
  var post = new ajxobj(base_url + '/admin/getDeptCourses/' + $(this).val());
  post.jxhr.done(function (res) {
...
$(document).on('click', '#delDeptCourseBtn', function () {
  var post = new ajxobj(base_url + '/admin/deleteDeptCourses/' + $(this).val());
  post.jxhr.done(function (res) {
    $('#departmentCoursesTable').html(res);
  });
});
...
$(document).on('click', '#addSectionQuestionsTab', function () {
  var post = new ajxobj(base_url + '/admin/addSectionQuestionsTab');
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
...
$(document).on('click', '#delSectionBtn', function () {
  var post = new ajxobj(base_url + '/admin/delSectionBtn/' + $(this).val());
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
    summernotInit('#secQstSummrNt', 'Type or copy and paste section question here...');
...
$(document).on('change', '#selSecQuesSectionsid', function () {
  var post = new ajxobj(base_url + '/admin/getSectionQuestionsTable/' + $(this).val());
  post.jxhr.done(function (res) {
...
$(document).on('click', '#delSecQuesBtn', function () {
  var post = new ajxobj(base_url + '/admin/delSecQuesBtn/' + $(this).val());
  post.jxhr.done(function (res) {
    $('#adminPage').html(res);
    summernotInit('#secQstSummrNt', 'Type or copy and paste section question here...');
  });
...
$(document).on('click', '#addQuestionsTab', function () {
  var post = new ajxobj(base_url + '/admin/addQuestionsTab');
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
...
$(document).on('change', '#SelectQuesCourse', function () {
  var post = new ajxobj(base_url + '/admin/getQuestionsTable/' + $(this).val());
  post.jxhr.done(function (res) {
...
$(document).on('change', '#quesSectionsid', function () {
  loadingMd();
  var post = new ajxobj(base_url + '/admin/getQuestionsTable/' + $('#SelectQuesCourse').val() + '/'
    + $(this).val());
  post.jxhr.done(function (res) {
    $('#questionsTableDiv').html(res);
    $('body').loadingModal('destroy');
...
$(document).on('change', '#frmquesSectionsid', function () {
  loadingMd();
  var post = new ajxobj(base_url + '/admin/getQuestionsTable/' + $('#frmSelectQuesCourse').val() + '/'
    + $(this).val());
  post.jxhr.done(function (res) {
    $('#questionsTableDiv').html(res);
    $('body').loadingModal('destroy');
...
$(document).on('click', '#delQuestBtn', function () {
  var post = new ajxobj(base_url + '/admin/delQuestBtn/' + $(this).val() + '/'
...
$(document).on('click', '#addRemoveStuTab', function () {
  var post = new ajxobj(base_url + '/admin/addRemoveStudentsTab');
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
  });
...
$(document).on('click', '#delStudentBtn', function () {
  var post = new ajxobj(base_url + '/admin/deleteSTudent/' + $(this).val());
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
  });
...
$(document).on('change', '#recomendationText', function () {
  var post = new ajxobj(base_url + '/admin/recomendationSaveTxt', 'POST', 'TEXT',
...
$(document).on('change', '#filterByEntry', function () {
  loadingMd();
  var post = new ajxobj(base_url + '/admin/addRemoveStudentsTab/' + $(this).val());
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
    $('body').loadingModal('destroy');
...
$(document).on('click', '#printStuPasswordsTab', function () {
  var post = new ajxobj(base_url + '/admin/printStuPasswordsTab');
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
  });
...
$(document).on('click', '#printStuPasswordsBtn', function () {
  ...
  var post = new ajxobj(base_url + '/admin/printStuPasswordsBtn', 'POST', 'HTML', { 'InstructionTxt': instructionText });
  post.jxhr.done(function (res) {
...
$(document).on('click', '#viewPrintResultTab', function () {
  loadingMd();
  var post = new ajxobj(base_url + '/admin/printStuScoreTab');
  post.jxhr.done(function (res) {
    $('body').loadingModal('destroy');
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
...
$(document).on('click', '#printScoreBtn', function () {
  var post = new ajxobj(base_url + '/admin/printStuScoreTab/Print');
  post.jxhr.done(function (res) {
    var w = window.open("", "Passwords", "scrollbars=yes,width=900,height=600");
    w.document.write(res);
...
$(document).on('click', '#delStudentScoreBtn', function () {
  var post = new ajxobj(base_url + '/admin/delStudentScoreBtn/' + $(this).val());
  post.jxhr.done(function (res) {
    $('body').loadingModal('destroy');
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
...
function getQuestionsBtns() {
  var post = new ajxobj(base_url + '/students/getAttemptedQuestions');
  post.jxhr.done(function (res) {
...
function finishExam() {
  var post = new ajxobj(base_url + '/students/finishedExam');
  post.jxhr.done(function (res) {
    // $('#dashNavbar').remove();
    $('#content').html(res);
  });
...
$(document).on('click', '#StartExam', function () {
  var post = new ajxobj(base_url + '/students/startExam', 'GET', 'JSON');
  post.jxhr.done(function (res) {
    ...
    getQuestionsBtns();
    var getDurPost = new ajxobj(base_url + '/students/getExamDurationAndTime', 'GET', 'JSON');
    setTimeout(function () {
...
$(document).on('click', '.optionAAnswer', function () {
  ...
  var post = new ajxobj(base_url + '/students/attemptSbumit/' + questionId + '/' + selectedOption);
  post.jxhr.done(function (res) {
    $(qstBtnId).removeClass('btn-info');
    $(qstBtnId).addClass('btn-success');
  });
...
$(document).on('click', '#nextQuestionBtn', function () {
  if (currentQuestion === numberOfQuestions - 1) {
    ...
    var post = new ajxobj(base_url + '/students/updateStuTime/' + crhr + '/' + crmin + '/' + crsec);
    post.jxhr.done(function (res) {
    });
  }
});
...
$(document).on('click', '#startStopExam', function () {
  var post = new ajxobj(base_url + '/admin/startStopExam');
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
  });
...
$(document).on('click', '#startExamBtn', function () {
  var post = new ajxobj(base_url + '/admin/startExamBtn');
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
  });
...
$(document).on('click', '#StopExamBtn', function () {
  var post = new ajxobj(base_url + '/admin/stopExamBtn');
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
  });
...
$(document).on('click', '#recomandationTab', function () {
  var post = new ajxobj(base_url + '/admin/recomandationTab');
  post.jxhr.done(function (res) {
    $('#dashNavbar').remove();
    $('#adminPage').html(res);
  });
